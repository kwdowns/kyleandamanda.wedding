      ...
      <article id={"events-timeline"}>
        ...
        {weddingEvents.map((event, index) => (
          ...
          >
            ...
            <div className="z-20 flex items-center order-1 bg-gray-800 shadow-xl w-28 h-10 rounded-full">
...
const weddingEvents: { time: string; title: string; description: string }[] = [
  ...
  },
  {
    ...
    title: "Cocktail Hour",
    description:
      "After the ceremony we will have a cocktail hour on the lower level of the venue in the speakeasy.",
  },
  {
    time: "6:30 PM",
    title: "Dinner",

...
interface RsvpFormProps {
  name: string;
  attending: boolean;
  food_preference: "none" | "vegan" | "vegetarian" | "gluten-free" | "peanut-allergy" | "dairy-allergy";
  guests: string | null;
...
function RsvpForm(formProps : RsvpFormProps) {
  ...
  return (
    <form>
      <label>Name:</label>
      <input type="text" value={props.name} onChange={(e) => setProps({...props, name: e.target.value})} />
      
      <label>Attending:</label>
      <input type="checkbox" checked={props.attending} onChange={(e) => setProps({...props, attending: e.target.checked})} />
      
      <label>Food Preference:</label>
      <select value={props.food_preference} onChange={(e) => setProps({...props, food_preference: e.target.value as RsvpFormProps["food_preference"]})}></select>
      
      <label>Guests:</label>
      <input type="text" onChange={(e) => setProps({...props, guests: e.target.value})}/>

...
function generateGalleryImageExports() {
  ...
  subDirs.forEach((subDir) => {
    ...
    subFiles.forEach((file) => {
      ...
      if(subexports[subDir] === undefined){
        subexports[subDir] = `export const ${subDir} = [`;
      }
  ...
  for(let subDir in subexports){
    console.log(subDir);
    let subexportStatement = subexports[subDir];
    subexportStatement = subexportStatement.substring(0, subexportStatement.length - 1);
    subexportStatement += "\r\n];";
    subexportStatements += `\r\n\r\n${subexportStatement}`;
  }
